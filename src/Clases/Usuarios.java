...
public class Usuarios {
    ...
    public int guardarUsuario(String Nombre, String Apellido, String Username, String Email, 
                             String Cargo, String Telefono, String Clave) throws SQLException {
        Conector db = new Conector();
        db.conectar();
        String query = "INSERT INTO usuarios (Nombre, Apellido, Username, Email, Cargo, Telefono, clave) "
                     + "VALUES (?, ?, ?, ?, ?, ?, ?)";
        return db.executeUpdate(query, Nombre, Apellido, Username, Email, Cargo, Telefono, Clave);
    }
    ...
    public int actualizarUsuario(int id, String Nombre, String Apellido, String Username, String Email, 
        ...
        return db.executeUpdate(query, Nombre, Apellido, Username, Email, Cargo, Telefono, Clave, id);
    }
