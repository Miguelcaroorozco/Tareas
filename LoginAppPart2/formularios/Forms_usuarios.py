...
class FormUsuarios(tk.Tk):
    ...
    def listar_usuarios(self):
        tk.Label(self.frame, text="Listado de usuarios", font=('Times', 10)).place(x=70, y=230)
        ...
        btneliminar = tk.Button(self.frame, text="Eliminar", font=('Times', 14), width=10, command=self.eliminar_usuario).place(x=100, y=580)
        btnactualizar = tk.Button(self.frame, text="Actualizar", font=('Times', 14), width=10, command=self.actualizar_usuario).place(x=200, y=580)
    ...
    def guardar_usuario(self):
        ...
        self.cargar_usuarios()
        self.limpiar()
        messagebox.showinfo("Información", "Se guardo la informacion del usuarios exitosamente")
    ...
    def eliminar_usuario(self):
        ...
        self.cargar_usuarios()
        self.limpiar()
        messagebox.showinfo("Información", "Se elimino la informacion del usuario exitosamente")
    ...
    def actualizar_usuario(self):
        ...
        self.cargar_usuarios()
        self.limpiar()
        messagebox.showinfo("Información", "Se actualizo la informacion del usuario exitosamente")